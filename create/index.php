...
$PAGE->set_url('/create/index.php');
$PAGE->set_pagelayout('standard');
$PAGE->set_title('Mentor Connect : List ATAL Mentors');
$strmessages = "List ATAL Mentors";
echo $OUTPUT->header();
...
$rendercontent = $renderobj->rendercreatetab();
echo $rendercontent;
?>
<?php
echo $OUTPUT->footer();
